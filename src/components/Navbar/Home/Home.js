...
import data from "../../diversity.json"
import pics from "../../diversityimg.json"
...
export default function Home() {
  ...
  const getSuggestions = () => {
    ...
    return (
      <div className="rbt-menu dropdown-menu show" style={{position:"absolute", display:"block",maxHeight:"300px",overflow:"auto",willChange:"transform",width:"311.4px",top:"0px",left:"0px"}}>
                  ...
                  <div className="row">
                    <div className="d-block col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    {
                      ...
                      <div className="diversity-at-work-diversitycard card">
                        <img className="card-img-top" src={pics.icon} alt=""></img>

  ...
  return (
    <div>
      <header class="headerTop">
        <nav class="pl-0 navbar navbar-expand-lg navbar-light">
          <div className="pl-3 pr-3 container">
            <a
              href="https://www.happiestminds.com"
              className="header_navbarBrand navbar-brand"
            >
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
              <div class="header_nav__2m5tv ml-auto navbar-nav">
                <div class="header_navItem__224B- header_navItemBorder__27x7D nav-item">
                  <a
                    class="header_navLink__3AcF_ active nav-link"
                    href="#"
                    alt=""
                  >
                    Home
                ...
                <div class="header_navItem__224B- nav-item">
                  <a class="header_navLink__3AcF_ nav-link" href="#">
                    Life@Work
                  </a>
                </div>
      ...
      <main className="layoutPage-container">
        <div className="home">
          ...
          <div className="job-search_jobSearch container-fluid">
            <div className="row">
              <div className="job-search_tagSearch col-xl-9 col-lg-8 col-md-7 col-sm-12 col-12">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                  <div className="rbt job-search_search__3qEYA">
                    <div>
                      <input
                        type="text"
                        autocomplete="off"
                ...
                <a class="job-search_searchIcon__2Nt4M" href="#">
                  <svg
              ...
              <div className="job-search_Rec col-xl-3 col-lg-4 col-md-5 col-sm-12 col-12">
                <p class="job-search_jobRecLink__1LTrL">
                  <a id="redirect-rec" className="text-white" href="#">
                    Recommend me a job
                    <svg
                      version="1.1"
                      id="Capa_1"
      ...
      <footer className="footer">
        <div className="footer_container">
          <div class="row">
            <div className="footer_column flex-column pl-0 pr-0 col-xl-2 col-lg-12 col-md-12 col-sm-12 col-12">
              <h3 className="footer_title">Information</h3>
              <div className="undefined nav-item">
                <a
                  href="https://www.happiestminds.com/"
                  class="footer_navLink__gtCts footer_linkContent pl-0 nav-link"
                >
                  Company Website
                </a>
              </div>
            ...
            <div className="footer_column flex-column pl-0 pr-0 col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12">
              <h3 className="footer_title">Address</h3>
              <p className="footer_linkContent mb-1">
                Happiest Minds Technologies Limited <br /> SMILES 2,3 & 4
              </p>
              <p>
                <a
                  href="https://bit.ly/38MRWKT"
                  className="footer_navLink__gtCts footer_linkContent pl-0 nav-link"
                >
                  Registered Office:
                  <br />
            ...
            <div className="footer_column flex-column pl-0 pr-0 col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
              <h3 className="footer_title flex-column">Follow Us</h3>
              <a
                href="https://www.facebook.com/happiestminds/"
                class="footer_linkContent footer_fontAwesomeIcon mr-3"
              >
                <svg
                  aria-hidden="true"
                  focusable="false"
            ...
            <div className="flex-column pl-0 col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
              ...
              <p>
                <a
                  ...
                  className="footer_linkContent"
                >
                  peoplepositions@happiestminds.com
                </a>
              </p>
              <p className="footer_linkContent">
                Call us on <br />
                +91 80 61960300
              </p>
              <p className="footer_linkContent">
        ...
        <nav className="footer_navbar navbar navbar-expand navbar-light">
          <div className="container">
            <span className="navbar-brand">
              <p className="footer_linkContent mb-0">
                © Happiest Minds 2023| All Rights Reserved
              </p>
            </span>
            <div class="footer_appVersion">
              <span>v0.1.0</span>
            </div>
          </div>
        </nav>
